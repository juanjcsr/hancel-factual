...
public class SendPanicService extends Service implements GooglePlayServicesClient.ConnectionCallbacks,
GooglePlayServicesClient.OnConnectionFailedListener{
	...
	public class ejecutaPanico extends AsyncTask<Void, Void, Void>
	{
		...
		protected Void doInBackground(Void... params) {
			...
			//String direccion = Util.geoCodeMyLocation(Lat, Long, getActivity());
		...
		protected void onPostExecute(Void result) {
					...
					/*Rastreo rastreo = (Rastreo) getApplicationContext().getSupportFragmentManager().findFragmentById(R.id.fragmentRastreo);
					if(rastreo!=null)
					{
